...
export const PulseCard = () => {
  return (
    <div className="animate-pulse relative flex p-2 sm:p-4 bg-bkg w-[100%]">
      <div className="flex items-center justify-center basis-4/12">
        <div className="w-[100px] h-[150px] bg-slate-700"></div>
      </div>
      <div className="text-right basis-8/12">
        <h2 className="text-[1rem] h-[1rem] md:text-[1.25rem] underline bg-slate-700"></h2>
        <p className="text-[1rem] pt-2 bg-slate-700 h-[1rem]"></p>
      </div>
    </div>
  );
};
